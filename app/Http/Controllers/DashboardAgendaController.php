...
class DashboardAgendaController extends Controller
{
    ...
    public function index()
    {
        ...
        $agendas = Agenda::with(['type'])->where('date', '>=', $date)->orderBy('date', 'asc')->get();
     ...
     * @return \Illuminate\Http\Response
     */
    // menjalankan fungsi tambah postingan yang diatas
    public function store(Request $request)
    {
        ...
        //     'footer' => 'Mohon untuk mengisi daftar kehadiran dengan login terlebih dahulu melalui aplikasi warga arga.com'
        // ];
        ...
        // return redirect('/dashboard/agendas')->with('success', 'Agenda baru berhasil ditambahkan dan email notifikasi sudah terkirim');
