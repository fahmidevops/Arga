  ...
  <div class="col-lg-4">
    ...
    <main class="form-signin w-100 m-auto">
      ...
      <form action="{{ url('/login') }}" method="post">
        ...
        <label for="email">Masukkan NIK</label>
          <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Masukkan NIK/Email" value="{{ old('email') }}" required autofocus>
          @error('email')
