  ...
  <div class="col-lg-8">
    <form method="post" action="{{ url('/dashboard/agendas/' . $agenda->slug) }}" class="mb-5">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ old('description', $agenda->description) }}" required>
        @error('description')        
        <div class="invalid-feedback">
          {{ $message }}
        </div>
